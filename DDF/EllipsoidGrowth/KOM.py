...
neumann_bc = dolfinx.fem.Constant(geometry.mesh, -100.0)
endo_neumann = ("ENDO", dolfinx.fem.Constant(geometry.mesh, 2.))
epi_neumann = ("EPI", dolfinx.fem.Constant(geometry.mesh, 1.0))
neumann_bc_values = [endo_neumann, epi_neumann]

'''Robin boundary conditions'''
epi_robin = ("EPI", dolfinx.fem.Constant(geometry.mesh, 100.0), dolfinx.fem.Constant(geometry.mesh, 1.0))
robin_bc_values = []
